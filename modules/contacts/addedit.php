...
<tr>
    <td valign="top" width="50%">
        ...
        <tr>
            ...
            <td nowrap="nowrap">
                <input type="text" class="text" name="contact_company_name" value="" maxlength="100" size="25" />
                </td>
        </tr>
        <tr>
            <td align="right" width="100"><?php echo $AppUI->_('Department');?>:</td>
            <td nowrap="nowrap">
                <input type="text" class="text" name="contact_department_name" value="" maxlength="100" size="25" />
